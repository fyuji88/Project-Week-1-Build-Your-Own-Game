...
#Assigning initial army forces for each player

army_balance = {player1:3, player2:3, player3:3}
...
#Game Winning Conditon: LAST ONE STANDING!
...
#Function for inputing attacking soldiers deployment, restricted by army balance, string input not allowed
